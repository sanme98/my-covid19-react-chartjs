                ...
                <h2 className="mb-3">About</h2>
                    <Card>                        
                        ...
                        <CardBody>
                            ...
                            <CardText>The data for this site is from <a href="https://github.com/MoH-Malaysia/covid19-public" target="_blank">Open data on COVID-19 in Malaysia</a> and this site will do some simple calculations to display the data. Please report the bugs if you found any bugs or miscalculations on this site, or even better, please fork the source code on Github, fix the bugs and contribute to the project.</CardText>
                            <CardTitle>Disclaimer</CardTitle>
                            <CardText>Please visit Covid-19 Data Official site for accurate Covid-19 information. This site is just for educational and learning purposes only. It has not gone through any rigorous testing, so it might still have some bugs or miscalculations.</CardText>
                            ...
                            <CardText>Please head to <a href="./" target="_blank">Testing</a> for some brief explanations.</CardText>
